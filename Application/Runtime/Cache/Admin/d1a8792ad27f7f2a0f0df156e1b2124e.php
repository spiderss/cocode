                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <!--</tr>-->
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="info[title]" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>链接地址：</th>
                                <td>
                                    <input class="common-text required" id="url" name="info[url]" size="50" value="" type="text">
                                </td>
                            </tr>
                            <!--<tr>-->
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="info[desc]" class="common-textarea" id="desc" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
