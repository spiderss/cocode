                ...
                <form action=" " method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="info[desc]" class="common-textarea" id="desc" cols="30" style="width: 98%;" rows="3"></textarea></td>
                            </tr>

                        <tr>
                            <th>内容：</th>
                            <td><textarea name="info[content]" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                        </tr>
