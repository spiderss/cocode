                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <!--</tr>-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="url" name="info[url]" size="50" value="<?php echo ($info["url"]); ?>" type="text">
                                </td>
                            </tr>
                            <!--<tr>-->
                                <!--<th><i class="require-red">*</i>缩略图：</th>-->
                                <!--<td><input name="smallimg" id="" type="file">&lt;!&ndash;<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>&ndash;&gt;</td>-->
                            <!--</tr>-->
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="info[desc]" class="common-textarea" id="desc" cols="30" style="width: 98%;" rows="10"><?php echo ($info["desc"]); ?></textarea></td>
                            </tr>
                        <tr>
                            <th>状态：</th>
                            <td>
                                <input type="checkbox" name="info[status]" value="1" <?php if($info["status"] == 1): ?>checked<?php endif; ?>>启用
                                <input type="checkbox" name="info[status]" value="0"  <?php if($info["status"] == 0): ?>checked<?php endif; ?>> 禁用
