    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                <a href="<?php echo U('admin/index');?>">首页</a><span class="crumb-step">&gt;</span>
                <span class="crumb-name">分类管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/tp3/index.php/Admin/Category/listorder" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($info["catename"]); ?>"><a target="_blank" href="#" title="<?php echo ($info["catename"]); ?>"><?php echo ($info["catename"]); ?></a> …
                            </td>


                            <td>
                                <a class="link-update" href="/tp3/index.php/Admin/Category/edit/id/<?php echo ($info["id"]); ?>">修改</a>
                                <a class="link-del ajax-del" href="/tp3/index.php/Admin/Category/del/id/<?php echo ($info["id"]); ?>" >删除</a>
                            </td>
