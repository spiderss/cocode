...
<div class="container clearfix">
    ...
    <!---    <div class="search-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/tp3/index.php/Admin/Article/listorder" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('add');?>"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <input class="common-input sort-input" name="<?php echo ($info["id"]); ?>" value="<?php echo ($info["sort"]); ?>" type="text">
                            </td>
                            <td><?php echo ($info["id"]); ?></td>
                            <td title="<?php echo ($info["title"]); ?>"><a target="_blank" href="<?php echo U('Home/article/index',array('id'=>$info[id]));?>" title="<?php echo ($info["title"]); ?>"><?php echo ($info["title"]); ?>
                            </a>
                                <?php if($info["pic"] != ''): ?><img src="/tp3<?php echo ($info["pic"]); ?>" width="30px"/><?php endif; ?>
                            </td>
                            ...
                            <td>
                                <a class="link-update" href="/tp3/index.php/Admin/Article/edit/id/<?php echo ($info["id"]); ?>">修改</a>
                                <a class="link-del ajax-del" href="/tp3/index.php/Admin/Article/del/id/<?php echo ($info["id"]); ?>" >删除</a>
                            </td>
