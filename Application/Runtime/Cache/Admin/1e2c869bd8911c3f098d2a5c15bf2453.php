...
<div class="container clearfix">
    ...
    <!---    <div class="search-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/tp3/index.php/Admin/Link/listorder" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('add');?>"><i class="icon-font"></i>新增友情链接</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($info["title"]); ?>"><a target="_blank" href="<?php echo ($info["url"]); ?>" title="<?php echo ($info["title"]); ?>"><?php echo ($info["title"]); ?></a> …
                            </td>
                            ...
                            <td>
                                <a class="link-update" href="/tp3/index.php/Admin/Link/edit/id/<?php echo ($info["id"]); ?>">修改</a>
                                <a class="link-del ajax-del" href="/tp3/index.php/Admin/Link/del/id/<?php echo ($info["id"]); ?>" >删除</a>
                            </td>
