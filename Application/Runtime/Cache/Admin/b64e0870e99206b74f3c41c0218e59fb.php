    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/">首页</a>
                <span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('admin/admin/index');?>">作品管理</a>
                <span class="crumb-step">&gt;</span><span>修改管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <!--</tr>-->
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="info[username]" size="50" value="<?php echo ($info["username"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" id="url" name="info[password]" size="50" value="" type="text">
                                </td>
                            </tr>
